...
No need for you to figure each one by yourself, the following list does it for you:
...
![Repositories Manager](/assets/repositories-manager.png)
...
![Filtered by Repository Owner](/assets/template-manager-filtered.png)
